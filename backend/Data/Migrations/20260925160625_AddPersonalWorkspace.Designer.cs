...
namespace backend.Data.Migrations
{
    ...
    [Migration("20260925160625_AddPersonalWorkspace")]
    partial class AddPersonalWorkspace
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.CmsContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Models.CmsContentVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Models.DocumentProcessingJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Backend.Models.Plan", b =>
                {
                    ...
                    b.Property<bool>("AllowAdvancedSettings")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Backend.Models.PlatformSettings", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("SignupsEnabled")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Backend.Models.CmsContentVersion", b =>
                {
                    b.HasOne("Backend.Models.CmsContent", null)
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("Backend.Models.SupportMessage", b =>
                {
                    b.HasOne("Backend.Models.SupportTicket", null)
                        .WithMany("Messages")
